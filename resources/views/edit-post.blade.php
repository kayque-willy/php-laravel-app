            ...
            <div>
                <form method="post" action="/editNewsApp/{{$news['id']}}">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control" name="title" placeholder="Título *" id="title" value="{{$news['title']}}">
                    </div>
                    <div class="form-group">
                        <input type="text" class="form-control" name="subtitle" placeholder="Subtítulo *" id="subtitle" value="{{$news['subtitle']}}">
                    </div>
                    <input type="hidden" name="author_id" id="author_id" value="{{$news['author_id']}}">
                    <textarea id="description" type="text" class="form-control" name="description" placeholder="Texto *">{{$news['description']}}</textarea>
